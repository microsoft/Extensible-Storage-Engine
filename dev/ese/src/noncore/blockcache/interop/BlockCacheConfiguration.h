            ...
            namespace Interop
            {
                public ref class BlockCacheConfiguration : public BlockCacheConfigurationBase<IBlockCacheConfiguration, ::IBlockCacheConfiguration, CBlockCacheConfigurationWrapper<IBlockCacheConfiguration, ::IBlockCacheConfiguration>>
                {
                    public:
                        ...
                        {
                            return Internal::Ese::BlockCache::Interop::ErrWrap<IBlockCacheConfiguration, ::IBlockCacheConfiguration, CBlockCacheConfigurationWrapper<IBlockCacheConfiguration, ::IBlockCacheConfiguration>>( bcconfig, ppbcconfig );
                        }
